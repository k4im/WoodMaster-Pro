...
export class Migrations1718484788649 implements MigrationInterface {
    name = 'Migrations1718484788649'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`address\` (\`Id\` int NOT NULL AUTO_INCREMENT, \`Uuid\` varchar(36) COLLATE "utf8_general_ci" NULL, \`StreetName\` varchar(255) NULL, \`City\` varchar(255) NULL, \`Neighborhood\` varchar(255) NULL, \`ZipCode\` varchar(255) NULL, \`Country\` varchar(255) NULL, \`State\` varchar(255) NULL, \`Observations\` varchar(255) NULL, \`personId\` int NULL, PRIMARY KEY (\`Id\`)) ENGINE=InnoDB`);
